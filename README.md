...
- [src/Schema/DemoEditor.js](./src/Schema/DemoEditor.js) demo UI-Schema generator:
- [src/Schema/UserSettings.js](./src/Schema/UserSettings.js) UI-Schema generator with `localStorage`
- [src/App.js](./src/App.js) main page / routing
