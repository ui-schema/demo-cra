...
const Editor = () => {
    ...
    if(!data || !schema) return <div style={{textAlign: 'center', margin: '75px 0'}}>
        <Refresh className={'App-refresh'} fontSize={'large'}/>
    ...
    return (
        <div className="App">
            ...
            <main className="App-main">
                <Editor/>
                <p>See <code>console.log</code> after clicking on <code>SEND!</code></p>
                <p style={{marginBottom: 48}}>Code in <a href={'https://github.com/ui-schema/demo-cra'}>ui-schema/demo-cra</a>, look in <a href={'https://github.com/ui-schema/demo-cra/blob/master/src/App.js'}>src/App.js</a></p>

                {showSettings ? <UserSettings/> : null}
                <Button variant={'contained'} style={{marginBottom: 24}} onClick={() => setShowSettings(c => !c)}>{showSettings ? 'Hide' : 'Show'} User Settings</Button>
            </main>
        </div>
    );
}
